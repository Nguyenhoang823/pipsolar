    ...
    switch (this->used_polling_commands_[this->last_polling_command_].identifier) {
      case POLLING_QPIRI:
        ...
        if (this->battery_recharge_voltage_select_) {
          char value[16];
          snprintf(value, sizeof(value), "%.1f", value_battery_recharge_voltage_);
          std::string mapped_value(value);
          this->battery_recharge_voltage_select_->map_and_publish(mapped_value);
        }
        ...
        if (this->battery_under_voltage_select_) {
          char value[16];
          snprintf(value, sizeof(value), "%.1f", value_battery_under_voltage_);
          std::string mapped_value(value);
          this->battery_under_voltage_select_->map_and_publish(mapped_value);
        }
        ...
        if (this->battery_bulk_voltage_select_) {
          char value[16];
          snprintf(value, sizeof(value), "%.1f", value_battery_bulk_voltage_);
          std::string mapped_value(value);
          this->battery_bulk_voltage_select_->map_and_publish(mapped_value);
        }
        ...
        if (this->battery_float_voltage_select_) {
          char value[16];
          snprintf(value, sizeof(value), "%.1f", value_battery_float_voltage_);
          std::string mapped_value(value);
          this->battery_float_voltage_select_->map_and_publish(mapped_value);
        }
        ...
        if (this->battery_redischarge_voltage_select_) {
          char value[16];
          snprintf(value, sizeof(value), "%.1f", value_battery_redischarge_voltage_);
          std::string mapped_value(value);
          this->battery_redischarge_voltage_select_->map_and_publish(mapped_value);
        }
